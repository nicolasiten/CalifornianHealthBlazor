...
namespace CalifornianHealthBlazor.Data.Migrations
{
    ...
    [Migration("20200413174005_Initial")]
            ...
            modelBuilder.Entity("CalifornianHealthBlazor.Data.Entities.Appointment", b =>
                {
                    ...
                    b.HasIndex("ConsultantFk", "PatientFk", "TimeSlotFk", "SelectedDate")
                        .IsUnique()
                        .HasFilter("[ConsultantFk] IS NOT NULL AND [PatientFk] IS NOT NULL AND [TimeSlotFk] IS NOT NULL");
